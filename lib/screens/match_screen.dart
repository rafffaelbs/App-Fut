    ...
    if (isTie) {
      ...
      if (redWon) {
        ...
        if (winLimit > 0 && redWinStreak >= winLimit) {
          ...
          popupMessage =
              "Vermelho ganhou $winLimit seguidas!\nSugestão: TODOS saem da quadra.";
          popupColor = Colors.redAccent;
        } else {
          suggestedLeavers.addAll(teamWhite);
          popupTitle = "Vitória do VERMELHO!";
          popupMessage = winLimit > 0
              ? "Sugestão: Branco sai.\n(Sequência do Vermelho: $redWinStreak/$winLimit)"
              : "Sugestão: Branco sai.\n(Vitórias seguidas: $redWinStreak)";
          popupColor = Colors.redAccent;
        }
      } else {
        whiteWinStreak++;
        ...
        if (winLimit > 0 && whiteWinStreak >= winLimit) {
          ...
          popupMessage =
              "Branco ganhou $winLimit seguidas!\nSugestão: TODOS saem da quadra.";
          popupColor = Colors.white;
        } else {
          suggestedLeavers.addAll(teamRed);
          popupTitle = "Vitória do BRANCO!";
          popupMessage = winLimit > 0
              ? "Sugestão: Vermelho sai.\n(Sequência do Branco: $whiteWinStreak/$winLimit)"
              : "Sugestão: Vermelho sai.\n(Vitórias seguidas: $whiteWinStreak)";
          popupColor = Colors.white;
        }
      }
    }
